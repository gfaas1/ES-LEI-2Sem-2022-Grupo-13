 ...
 * @see DirectedWeightedGraphBuilderBase
 * @see UndirectedWeightedGraphBuilderBase
 */
public abstract class AbstractWeightedGraphBuilder
        <V, E, G extends WeightedGraph<V, E>,
                B extends AbstractWeightedGraphBuilder<V, E, G, B>>
        extends AbstractGraphBuilder<V, E, G, B>
{
     ...
     */
    public AbstractWeightedGraphBuilder(G baseGraph)
    {
        super(baseGraph);
    }
...
// End WeightedGraphBuilderBase.java
