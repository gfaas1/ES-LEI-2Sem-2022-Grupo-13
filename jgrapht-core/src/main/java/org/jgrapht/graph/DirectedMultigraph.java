    ...
    implements DirectedGraph<V, E>
{
     ...
     */
    public static <V, E> GraphBuilderBase<V, E, ? extends DirectedMultigraph<V, E>> createBuilder(
        Class<? extends E> edgeClass)
    {
        return new GraphBuilderBase<>(new DirectedMultigraph<>(edgeClass));
    }
    ...
    public static <V, E> GraphBuilderBase<V, E, ? extends DirectedMultigraph<V, E>> createBuilder(
        EdgeFactory<V, E> ef)
    {
        return new GraphBuilderBase<>(new DirectedMultigraph<>(ef));
    }
