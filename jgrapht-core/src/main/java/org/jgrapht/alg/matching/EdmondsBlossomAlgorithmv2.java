...
//
//    /* The representatives cache tracks for each vertex its representatives. If the vertex is part of a blossom, then the representatives
//    of that blossom is returned. Otherwise, the vertex represents itself. A blossom is a cycle of odd length in the original grahp.
//     Given an edge (u,v), if the two vertices u, v belong to the same blossom,
//     in [1] denoted by R(u)=R(v), then the edge (u,v) has been 'shrunken away'. Initially, each vertex represents itself.
//     */
//    UnionFind<Integer> representatives
//            ;
//
//    /*
...
//        representatives =new UnionFind<>(vertexIndexMap.values());
//
