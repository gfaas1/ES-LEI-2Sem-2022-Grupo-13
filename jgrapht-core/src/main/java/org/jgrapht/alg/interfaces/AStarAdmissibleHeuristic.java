...
public interface AStarAdmissibleHeuristic<V> {
    ...
    /**
     * Returns true if the heuristic is a <i>consistent</i> or <i>monotone</i> heuristic
     * wrt the provided {@code graph}. A heuristic is monotonic if its estimate is always
