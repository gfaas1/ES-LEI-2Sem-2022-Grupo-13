...
public interface VertexCoverAlgorithm<V> {
            ...
            extends Set<V>
    {
        ...
        /**
         * Returns the weight of the vertex cover. When solving a weighted vertex cover
         * problem, the weight returned is the sum of the weights of the vertices in the vertex cover. When
     ...
     * @param <V> the vertex type
     */
    class VertexCoverImpl<V> extends WeightedUnmodifiableSet<V>
