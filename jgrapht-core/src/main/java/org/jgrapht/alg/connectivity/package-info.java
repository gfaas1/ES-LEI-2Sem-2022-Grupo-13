 ...
 * A graph that is not connected is disconnected. A connected component is a maximal connected subgraph of $G$. Each vertex belongs
 ...
 * connected (undirected) graph. It is strongly connected if it contains a directed
 * path from $u$ to $v$ and a directed path from $v$ to $u$ for every pair of vertices $u$, $v$. The strong components
