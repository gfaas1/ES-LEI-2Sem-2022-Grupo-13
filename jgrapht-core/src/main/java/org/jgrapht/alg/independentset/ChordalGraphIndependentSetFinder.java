...
/**
 * Calculates a <a href = "http://mathworld.wolfram.com/MaximumIndependentVertexSet.html">maximum cardinality independent set</a> in a <a href="https://en.wikipedia.org/wiki/Chordal_graph">chordal graph</a>.
 ...
 *
 * To compute the independent set, this implementation relies on the {@link ChordalityInspector} to compute a
 ...
 *
 * The maximum cardinality independent set for a chordal graph is computed in $\mathcal{O}(|V| + |E|)$ time.
 *
 ...
 * @since March 2018
 */
public class ChordalGraphIndependentSetFinder<V,E> implements IndependentSetAlgorithm<V,E> {
    ...
    /**
     * Creates a new ChordalGraphIndependentSetFinder instance. The {@link ChordalityInspector} used in this implementation uses
