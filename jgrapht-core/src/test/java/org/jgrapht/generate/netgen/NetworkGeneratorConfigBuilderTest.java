...
public class NetworkGeneratorConfigBuilderTest {
    ...
    private NetworkGeneratorConfigBuilder getBuilder(int nodeNum, int arcNum, int sourceNum, int sinkNum, int tSourceNum, int tSinkNum, int supply, int minCap, int maxCap, int minCost, int maxCost, int pCapacitated, int pWithInfCost) {
        return new NetworkGeneratorConfigBuilder().setNodeNum(nodeNum).setArcNum(arcNum)
                .setSourceNum(sourceNum).setSinkNum(sinkNum)
                .setTSourceNum(tSourceNum).setTSinkNum(tSinkNum)
                .setTotalSupply(supply)
                .setMinCap(minCap).setMaxCap(maxCap)
                .setMinCost(minCost).setMaxCost(maxCost)
...
// -------------------------- node num tests --------------------------
    ...
    public void testNodeNum_NodeNumNotSet_IllegalArgumentException() {
        NetworkGeneratorConfig config = new NetworkGeneratorConfigBuilder().setArcNum(20)
                .setSourceNum(2).setSinkNum(3)
                .setTSourceNum(1).setTSinkNum(1)
                .setTotalSupply(50)
                .setMinCap(1).setMaxCap(10)
                .setMinCost(0).setMaxCost(10)
...
// -------------------------- arc num tests --------------------------
    ...
    public void testArcNum_ArcNumNotSet_IllegalArgumentException() {
        NetworkGeneratorConfig config = new NetworkGeneratorConfigBuilder().setNodeNum(10)
                .setSourceNum(2).setSinkNum(3)
                .setTSourceNum(1).setTSinkNum(1)
                .setTotalSupply(50)
                .setMinCap(1).setMaxCap(10)
...
// -------------------------- source and sink node num tests --------------------------
    ...
    public void testSourceNum_SourceNumNotSet_IllegalArgumentException() {
        NetworkGeneratorConfig config = new NetworkGeneratorConfigBuilder().setNodeNum(10).setArcNum(20)
                .setSinkNum(3)
                .setTSourceNum(1).setTSinkNum(1)
                .setTotalSupply(50)
                .setMinCap(1).setMaxCap(10)
...
// -------------------------- capacities tests --------------------------
    ...
    public void testCapacities_MaximumMinimumCapacity_Ok() {
        getMinCostFlowBuilder().setMinCap(CAPACITY_COST_BOUND).setMaxCap(CAPACITY_COST_BOUND).build();
    }
