...
public class WindmillGraphsGeneratorTest {
    ...
    public void testCubicalGraph(){
        ...
        GeneralizedPetersenGraphGenerator<Integer, DefaultEdge> gpgg=new GeneralizedPetersenGraphGenerator<>(4, 1);
    ...
    public void testGraph1a(){
        Graph<Integer, DefaultEdge> g=new SimpleGraph<>(DefaultEdge.class);
        new WindmillGraphsGenerator<Integer, DefaultEdge>(WindmillGraphsGenerator.Mode.WINDMILL, 3, 4).generateGraph(g, new IntegerVertexFactory(), null);
    ...
    public void testGraph2a(){
        Graph<Integer, DefaultEdge> g=new SimpleGraph<>(DefaultEdge.class);
        new WindmillGraphsGenerator<Integer, DefaultEdge>(WindmillGraphsGenerator.Mode.WINDMILL, 4, 3).generateGraph(g, new IntegerVertexFactory(), null);
    ...
    public void testGraph3a(){
        Graph<Integer, DefaultEdge> g=new SimpleGraph<>(DefaultEdge.class);
        new WindmillGraphsGenerator<Integer, DefaultEdge>(WindmillGraphsGenerator.Mode.WINDMILL, 3, 5).generateGraph(g, new IntegerVertexFactory(), null);
    ...
    public void testGraph2b(){
        Graph<Integer, DefaultEdge> g=new SimpleGraph<>(DefaultEdge.class);
        new WindmillGraphsGenerator<Integer, DefaultEdge>(WindmillGraphsGenerator.Mode.DUTCHWINDMILL, 4, 3).generateGraph(g, new IntegerVertexFactory(), null);
        assertEquals(9, g.vertexSet().size());
        assertEquals(12, g.edgeSet().size());
    ...
    public void testGraph3b(){
        Graph<Integer, DefaultEdge> g=new SimpleGraph<>(DefaultEdge.class);
        new WindmillGraphsGenerator<Integer, DefaultEdge>(WindmillGraphsGenerator.Mode.DUTCHWINDMILL, 3, 5).generateGraph(g, new IntegerVertexFactory(), null);
        assertEquals(13, g.vertexSet().size());
