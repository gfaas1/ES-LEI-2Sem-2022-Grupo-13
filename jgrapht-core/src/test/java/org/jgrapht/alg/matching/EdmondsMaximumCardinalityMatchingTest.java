    ...
    extends TestCase
{
    ...
    public void testIsMaximumMatching(){
        ...
        //Perfect matching
        Matching<Integer, DefaultEdge> m1=new MatchingAlgorithm.MatchingImpl<>(g, new HashSet<>(Arrays.asList(e12, e34)), 2);
        ...
        Matching<Integer, DefaultEdge> m2=new MatchingAlgorithm.MatchingImpl<>(g, new HashSet<>(Collections.singletonList(e12)), 2);
    ...
    public void testIsMaximumMatching2(){
        ...
        int[][] edges={{0,8}, {9,7}, {5,3}, {9,4}, {3,2}, {5,4}, {1,0}, {3,8}, {4,7}, {2,0}, {8,5}, {0,5}, {8,1}};
        for(int[] edge : edges)
