...
public class ZhangShashaTreeEditDistanceTest {
    ...
    public void testTED_treeWithOneVertex_to_treeWithOneVertex() {
        Set<EditOperation<Integer>> expectedEditOperations = Collections.singleton(
                new EditOperation<>(OperationType.CHANGE, 1, 1));
        testOnTrees(getGraphWithOneVertex(), 1, getGraphWithOneVertex(), 1, 0.0, expectedEditOperations);
    }
    ...
    public void testTED_treeWithOneVertex_to_articleTree2() {
        ...
        testOnTrees(getGraphWithOneVertex(), 1, readGraph(articleTree2), 1, 5.0, expectedEditOperations);
    }
    ...
    public void testTED_articleTree1_to_treeWithOneVertex() {
        ...
        testOnTrees(readGraph(articleTree1), 1, getGraphWithOneVertex(), 1, 5.0, expectedEditOperations);
    }
    ...
    public void testTED_articleTree1_to_articleTree2() {
        ...
        testOnTrees(readGraph(articleTree1), 1, readGraph(articleTree2), 1, 2.0, expectedEditOperations);
    }
    ...
    /**
     * Tests the {@link ZhangShashaTreeEditDistance} algorithm on {@code tree1}
     * and {@code tree2} instances. This method expects to get edit distance value
     * equal to {@code expectedDistance} and list of edit operations equal to
     * {@code expectedEditOperations}.
     *
    ...
    private static void testOnTrees(Graph<Integer, DefaultEdge> tree1, int root1,
        ...
        List<EditOperation<Integer>> actualEditOperations = treeEditDistance.getEditOperationLists();
