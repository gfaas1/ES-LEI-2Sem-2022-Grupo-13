...
public class MinSourceSinkCutTest extends TestCase{
			...
			double cutWeight)
	{
		...
		DirectedGraph<Integer, DefaultWeightedEdge> network = new SimpleDirectedWeightedGraph<>(DefaultWeightedEdge.class);
		int m = tails.length;
		for (int i = 0; i < m; i++)
		...
		MinSourceSinkCut<Integer, DefaultWeightedEdge> mc= new MinSourceSinkCut<>(network);
		mc.computeMinCut(source, sink);

		assertEquals(cutWeight, mc.cutWeight);
