...
1. Review the README.md, HISTORY.md, CONTRIBUTORS.md, and update:
    ...
    * Contributors
    * Copyright year
1. Review/update github issues to make sure they reflect the current state.  If there were important bug/feature changes, it is worth
...
1. Reformat all code [using Eclipse](etc/codeFormatter.sh). 
