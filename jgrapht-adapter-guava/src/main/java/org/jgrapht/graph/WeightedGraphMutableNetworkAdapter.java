 ...
 */
public class WeightedGraphMutableNetworkAdapter<V, E>
    extends
    GraphMutableNetworkAdapter<V, E>
    implements
    Cloneable,
    Serializable
{
    private static final long serialVersionUID = -7538005856761682307L;
     ...
     */
    public WeightedGraphMutableNetworkAdapter(MutableNetwork<V, E> network, EdgeFactory<V, E> ef)
    {
        super(network, ef);
     ...
     */
    public WeightedGraphMutableNetworkAdapter(
        MutableNetwork<V, E> network, Class<? extends E> edgeClass)
    {
    ...
    public Object clone()
    {
        WeightedGraphMutableNetworkAdapter<V, E> newGraph =
