...
- **version 1.2.1** (under development):
    ...
    - Removed code not dual licensed under EPL-1.0 and LGPL-2.1-or-later: `AsUnweightedGraph` and `AsUnweightedDirectedGraph` are gone. (supported by Robert Höttger and Oliver Kopp)
