...
/**
 * Implementation of
 * {@literal <a href = "https://doi.org/10.1016/S0166-218X(96)00010-8">}
 * Parberry's algorithm{@literal </a>} for {@literal <a href = "https://en.wikipedia.org/wiki/Knight%27s_tour">}closed knight's tour problem{@literal </a>}.
 *
 * This algorithm was firstly introduced in "Discrete Applied Mathematics"
 * Volume 73, Issue 3, 21 March 1997, Pages 251-260.
 *
 ...
 * please refer to the illustration on the page 3 of the paper
 * {@literal <a href = "https://doi.org/10.1016/S0166-218X(96)00010-8">}
 ...
 * closed knight's tour became open knight's tour. Contract these $4$ boards by adding $4$ additional edges between the quadrants.
 */
...
public class ParberryKnightTour
{
    ...
    public ParberryKnightTour(int n, int m) {
        ...
        /*
         Theorem 2.1 (page 3 Parberry's paper)
         For all even n >= 6 there exist
         a structured knight's tour on n x n  board and n x (n + 2) board.
