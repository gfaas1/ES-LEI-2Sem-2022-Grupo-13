    ...
    implements GraphImporter<V, E>
{
    ...
    {
        this.delegate = new org.jgrapht.io.GmlImporter<>(vertexProvider, edgeProvider);
    }
    ...
    {
        this.delegate.setVertexProvider(vertexProvider);
    }
    ...
    {
        this.delegate.setEdgeProvider(edgeProvider);
    }
